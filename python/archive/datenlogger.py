...
GPIO.add_event_detect(24, GPIO.RISING, callback=my_callback_select, bouncetime=300)
GPIO.add_event_detect(25, GPIO.RISING, callback=my_callback_start_stop, bouncetime=300)
...
while True:
    ...
    while Start == True:
        ...
        if HF59B == True:
          ...
          power = voltage * 1000
          print ("voltage: (%.3fV) (%.3fuW)" % (voltage, leistung), dateTimeObj, "HF59B")
        ...
        if HFW59D == True:
          ...
          voltage = 2.47 * analog_value / 1024
          power = voltage * 1000
          print ("voltage: (%.3fV) (%.3fuW)" % (voltage, leistung), dateTimeObj, "HFW59D")
